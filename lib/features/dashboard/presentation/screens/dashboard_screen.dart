...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  void initState() {
    ...
    // Check for payment redirect query parameters on Web

    WidgetsBinding.instance.addPostFrameCallback((_) async {
      // Instantly clear any lingering snackbars from previous screens
      if (mounted) {
      ...
      if (kIsWeb && mounted) {
        ...
        final txRef = queryParams['tx_ref'] ?? queryParams['transaction_id'];
        ...
        if (txRef != null &&
          ...
          try {
            ...
            if (txRes != null && txRes['status'] == 'pending') {
              final double amount = (txRes['amount'] ?? 0.0).toDouble();

              final String userId = txRes['user_identifier'] as String;

              // 1. Update Transaction to Success in DB
              ...
              try {
                await Supabase.instance.client.rpc(
                  ...
                  params: {'user_id': userId, 'amount_to_add': amount},
                );
              } catch (_) {
                ...
                final double currentBalance =
                    (balanceRes?['naira_balance'] ?? 0.0).toDouble();
  ...
  Future<void> _fetchInitialWalletData() async {
    ...
    try {
      ...
      if (response != null && mounted) {
        setState(() {
          _fallbackCryptoBalance = (response['crypto_balance'] ?? 0.0)
              .toDouble();

          _fallbackCryptoFiatValue = _fallbackCryptoBalance;

          _fallbackCryptoAddress =
              response['account_or_public_key'] ?? "0xWeb3...Wallet";
  ...
  Widget build(BuildContext context) {
    ...
    final iconWrapperBg = isDarkMode
        ? const Color(0xFF1E2235)
        : const Color(0xFFF1F5F9);

    final subSectionTitleColor = isDarkMode
        ? Colors.grey[500]
    ...
    return BlocBuilder<AuthBloc, AuthState>(
      builder: (context, state) {
        ...
        String fallbackName = _getFirstName(
        ...
        return StreamBuilder<List<Map<String, dynamic>>>(
          ...
          builder: (context, profileSnapshot) {
            ...
            if (profileSnapshot.hasData &&
              ...
              profileUsdBalanceFallback = (row['usd_balance'] ?? 0.0)
                  .toDouble();
            }
            ...
            final double actualLiveUsd = walletAsyncValue.when(
              data: (walletMap) {
                ...
                return _fallbackFiatUsdBalance > 0
                    ? _fallbackFiatUsdBalance
                    : profileUsdBalanceFallback;
              },
              loading: () => _fallbackFiatUsdBalance > 0
                  ? _fallbackFiatUsdBalance
                  : profileUsdBalanceFallback,
              error: (_, __) => _fallbackFiatUsdBalance > 0
                  ? _fallbackFiatUsdBalance
                  : profileUsdBalanceFallback,
            );
              ...
              appBar: AppBar(
                ...
                actions: [
                  IconButton(
                    ...
                    onPressed: () => widget.onNavigateToSubScreen(
                  ...
                  IconButton(
                    ...
                    onPressed: () =>
                        widget.onNavigateToSubScreen(const ChatScreen()),
                  ),
                ],
              ),
              body: SafeArea(
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                            color: emeraldColor.withOpacity(
                                              0.4,
                                            ),
                                          ),
                                        ),
                            ...
                            children: [
                              _buildDashboardCard(
                                ...
                                balance: _isBalanceHidden
                                    ? '••••••'
                                    : '\$${actualLiveUsd.toStringAsFixed(2)}',
                              ...
                              _buildDashboardCard(
                                ...
                                balance: _isBalanceHidden
                                    ? '••••••'
                                    : '${liveCryptoBalance.toStringAsFixed(2)} USDT',
                                subBalance: _isBalanceHidden
                                    ? '••••••'
                                    : '\$${liveCryptoFiatValue.toStringAsFixed(2)} USD',
