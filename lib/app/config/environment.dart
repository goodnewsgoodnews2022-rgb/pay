...
class Environment {
  ...
  /// Flutterwave Secret Key environment mapping (DO NOT use this in client calls)
  ...
  /// 🚀 ADDED: Flutterwave Redirect URL
  /// This must be a URL that Flutterwave can redirect back to (and it should match what you configured in Flutterwave dashboard).
  static const String flutterwaveRedirectUrl = String.fromEnvironment(
    'FLUTTERWAVE_REDIRECT_URL',
    defaultValue: 'https://your-redirect-url.com',
  );

  /// NowPayments API Key environment mapping
  ...
  static void validate() {
    ...
    if (flutterwavePublicKey.contains('FLWPUBK_TEST') ||
        flutterwaveSecretKey.contains('FLWSECK_TEST')) {
      print('⚠️ WARNING: Flutterwave keys are using placeholder default values.');
    }

    if (flutterwaveRedirectUrl == 'https://your-redirect-url.com') {
      print('⚠️ WARNING: flutterwaveRedirectUrl is still using the placeholder value.');
    }
